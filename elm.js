...
var $author$project$Main$Bird = F2(
	function (id, isAnimating) {
		return {x: id, G: isAnimating};
	});
	...
	return _Utils_Tuple2(
		{
			r: A2(
				$elm$core$List$map,
				function (id) {
					return A2($author$project$Main$Bird, id, false);
				},
...
var $author$project$Main$DelayedStopAnimation = function (a) {
	return {$: 2, a: a};
};
var $elm$core$Process$sleep = _Process_sleep;
var $author$project$Main$updateBird = F3(
	function (id, animating, bird) {
		return _Utils_eq(bird.x, id) ? _Utils_update(
			bird,
			{G: animating}) : bird;
	});
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							r: A2(
								$elm$core$List$map,
								A2($author$project$Main$updateBird, id, true),
								model.r)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				...
				var task = A2(
					...
					function (_v1) {
						return $author$project$Main$DelayedStopAnimation(id);
					},
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							r: A2(
								$elm$core$List$map,
								A2($author$project$Main$updateBird, id, false),
								model.r)
						}),
					$elm$core$Platform$Cmd$none);
		}
...
var $author$project$Main$StartAnimation = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$StopAnimation = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$viewBird = function (bird) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('birb-wrapper'),
				$elm$html$Html$Events$onMouseEnter(
				$author$project$Main$StartAnimation(bird.x)),
				$elm$html$Html$Events$onMouseLeave(
				$author$project$Main$StopAnimation(bird.x)),
				A2(
				$elm$html$Html$Events$on,
				'touchstart',
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$class('birb'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$class('birb-head'),
								$elm$svg$Svg$Attributes$style(
								'animation-play-state: ' + (bird.G ? 'running' : 'paused'))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$svg$Svg$Attributes$d('M 60 30 Q 50 40 60 50 Q 70 40 60 30 Z'),
										$elm$svg$Svg$Attributes$fill('white')
									]),
								_List_Nil)
							]))
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$viewBird, model.r));
};
